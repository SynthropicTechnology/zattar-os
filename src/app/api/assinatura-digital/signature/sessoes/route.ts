...
import { listSessoes } from '@/app/(authenticated)/assinatura-digital/feature/services/signature.service';
import type { ListSessoesParams } from '@/app/(authenticated)/assinatura-digital/feature';
