        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-end">
          <div className="md:col-span-8 relative z-10">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold tracking-tighter leading-[1.1] mb-8 text-white">
              Insights e Tendências do <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dim drop-shadow-[0_0_15px_rgba(204,151,255,0.4)]">Direito do Amanhã.</span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-surface-container border border-white/5 aspect-[16/10] md:aspect-auto flex flex-col justify-end shadow-xl cursor-pointer">
            ...
            <div className="relative z-10 p-8 md:p-12 w-full mt-auto">
              ...
              <p className="text-zinc-300 mb-8 line-clamp-2 max-w-xl text-lg leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            ...
            <Link href="#" className="flex flex-col sm:flex-row gap-6 group">
              <div className="flex-shrink-0 w-full sm:w-40 h-40 rounded-2xl bg-surface-container-highest overflow-hidden relative">
                <img 
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 p-12 md:p-20 items-center">
            <div>
              <h2 className="font-headline text-4xl md:text-5xl font-extrabold mb-6 text-white tracking-tight leading-tight">
                Fique por dentro das <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dim">atualizações jurídicas.</span>
              </h2>
            ...
            <div className="space-y-4 max-w-xl lg:ml-auto w-full">
              <div className="flex flex-col sm:flex-row gap-4">
                <input 
                  className="flex-grow bg-surface-container-high border border-white/5 focus:border-primary/50 rounded-xl px-6 py-5 text-white placeholder:text-zinc-500 focus:ring-1 focus:ring-primary/50 outline-none transition-all shadow-inner" 
              ...
              <p className="text-sm text-zinc-500 leading-relaxed pl-2 mt-4">
